...
static const struct dev_data am64x_dev_blazar_mcu_0_cbass_0 __attribute__((__section__(".const.devgroup.MCU_WAKEUP"))) = {
	...
	.dev_clk_idx		= AM64X_DEV_BLAZAR_MCU_0_CBASS_0_CLOCKS,
	.n_clocks		= 1,
	.pm_devgrp		= PM_DEVGRP_01,
};
...
static struct psc_pd am64x_sam64_main_psc_wrap_main_0_powerdomains[AM64X_PSC_PD_PD_SPARE1 + 1] __attribute__((__section__(".bss.devgroup.MAIN")));
static const dev_idx_t dev_list_LPSC_main_alwayson[80] __attribute__((__section__(".const.devgroup.MAIN"))) = {
...
static struct lpsc_module am64x_sam64_main_psc_wrap_main_0_modules[AM64X_PSC_LPSC_LPSC_SPARE_1 + 1] __attribute__((__section__(".bss.devgroup.MAIN")));
...
static struct psc_pd am64x_sam64_mcu_psc_wrap_mcu_0_powerdomains[AM64X_PSC_PD_PD_M4F + 1] __attribute__((__section__(".bss.devgroup.MCU_WAKEUP")));
static const dev_idx_t dev_list_LPSC_mcu_alwayson[16] __attribute__((__section__(".const.devgroup.MCU_WAKEUP"))) = {
...
static struct lpsc_module am64x_sam64_mcu_psc_wrap_mcu_0_modules[AM64X_PSC_LPSC_LPSC_M4F + 1] __attribute__((__section__(".bss.devgroup.MCU_WAKEUP")));
...
static const struct dev_clk_data MCU_WAKEUP_dev_clk_data[224] __attribute__((__section__(".const.devgroup.MCU_WAKEUP"))) = {
	...
	DEV_CLK_PARENT(AM64X_DEV_DMTIMER_DMC1MS_MCU_0_CLOCKS,		     AM64X_DEV_MCU_TIMER0_TIMER_TCLK_CLK_PARENT_GLUELOGIC_HFOSC0_CLKOUT,		    CLK_AM64X_GLUELOGIC_HFOSC0_CLKOUT,
		       1,
		       0),
	DEV_CLK_PARENT(AM64X_DEV_DMTIMER_DMC1MS_MCU_0_CLOCKS,		     AM64X_DEV_MCU_TIMER0_TIMER_TCLK_CLK_PARENT_K3_PLL_CTRL_WRAP_MCU_0_CHIP_DIV1_CLK_CLK2,
		       CLK_AM64X_K3_PLL_CTRL_WRAP_MCU_0_CHIP_DIV1_CLK_CLK,   2,
		       1),
	...
	DEV_CLK_PARENT(AM64X_DEV_DMTIMER_DMC1MS_MCU_1_CLOCKS,		     AM64X_DEV_MCU_TIMER1_TIMER_TCLK_CLK_PARENT_GLUELOGIC_HFOSC0_CLKOUT,		    CLK_AM64X_GLUELOGIC_HFOSC0_CLKOUT,
		       1,
		       0),
	DEV_CLK_PARENT(AM64X_DEV_DMTIMER_DMC1MS_MCU_1_CLOCKS,		     AM64X_DEV_MCU_TIMER1_TIMER_TCLK_CLK_PARENT_K3_PLL_CTRL_WRAP_MCU_0_CHIP_DIV1_CLK_CLK2,
		       CLK_AM64X_K3_PLL_CTRL_WRAP_MCU_0_CHIP_DIV1_CLK_CLK,   2,
		       1),
	...
	DEV_CLK_PARENT(AM64X_DEV_DMTIMER_DMC1MS_MCU_2_CLOCKS,		     AM64X_DEV_MCU_TIMER2_TIMER_TCLK_CLK_PARENT_GLUELOGIC_HFOSC0_CLKOUT,		    CLK_AM64X_GLUELOGIC_HFOSC0_CLKOUT,
		       1,
		       0),
	DEV_CLK_PARENT(AM64X_DEV_DMTIMER_DMC1MS_MCU_2_CLOCKS,		     AM64X_DEV_MCU_TIMER2_TIMER_TCLK_CLK_PARENT_K3_PLL_CTRL_WRAP_MCU_0_CHIP_DIV1_CLK_CLK2,
		       CLK_AM64X_K3_PLL_CTRL_WRAP_MCU_0_CHIP_DIV1_CLK_CLK,   2,
		       1),
	...
	DEV_CLK_PARENT(AM64X_DEV_DMTIMER_DMC1MS_MCU_3_CLOCKS,		     AM64X_DEV_MCU_TIMER3_TIMER_TCLK_CLK_PARENT_GLUELOGIC_HFOSC0_CLKOUT,		    CLK_AM64X_GLUELOGIC_HFOSC0_CLKOUT,
		       1,
		       0),
	DEV_CLK_PARENT(AM64X_DEV_DMTIMER_DMC1MS_MCU_3_CLOCKS,		     AM64X_DEV_MCU_TIMER3_TIMER_TCLK_CLK_PARENT_K3_PLL_CTRL_WRAP_MCU_0_CHIP_DIV1_CLK_CLK2,
		       CLK_AM64X_K3_PLL_CTRL_WRAP_MCU_0_CHIP_DIV1_CLK_CLK,   2,
		       1),
...
static const struct dev_clk_data MAIN_dev_clk_data[705] __attribute__((__section__(".const.devgroup.MAIN"))) = {
...
static struct dev_clk MAIN_dev_clk[705] __attribute__((__section__(".bss.devgroup.MAIN")));
...
const struct devgroup soc_devgroups[AM64X_PM_DEVGRP_RANGE_ID_MAX] = {
	[PM_DEVGRP_01] =   {
...
const struct dev_data *const soc_device_data_arr[AM64X_DEV_COMPUTE_CLUSTER0_PBIST_0 + 1U] = {
	...
	[AM64X_DEV_MCU_M4FSS0_CBASS_0] = &am64x_dev_blazar_mcu_0_cbass_0,
...
struct device soc_devices[AM64X_DEV_COMPUTE_CLUSTER0_PBIST_0 + 1U];
